...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        /**
         * Number of values that should be calculated sequentially.
         */
        ...
        protected void compute() {
            if(this.endIndexExclusive - this.startIndexInclusive <= SEQUENTIAL_THRESHOLD){
                ...
                int midPoint = (this.startIndexInclusive + this.endIndexExclusive) / 2;
                
                // create left and right tasks
                ...
                // fork and join left, compute right
                // could also have used higher-level APIs and invokeAll here.
                left.fork();
                right.compute();
                left.join();
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        // Create n tasks that represents each set of work
        for(int n = 0; n < numTasks; n++){
            // Each task is calculated from each chunk
            ReciprocalArraySumTask t = new ReciprocalArraySumTask(
                getChunkStartInclusive(n, numTasks, input.length),
                getChunkEndExclusive(n, numTasks, input.length),
                input
            );
            pool.invoke(t);
            sum += t.value;
